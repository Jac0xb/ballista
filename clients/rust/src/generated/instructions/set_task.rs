...
impl SetTask {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SetTaskInstructionData::new().try_to_vec().unwrap();
...
pub struct SetTaskInstructionData {
    discriminator: u8,
}

impl SetTaskInstructionData {
    pub fn new() -> Self {
...
pub struct SetTaskInstructionArgs {
    pub task_index: u8,
    pub task: TaskDefinition,
}

/// Instruction builder for `SetTask`.
///
/// ### Accounts:
///
...
impl SetTaskBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = SetTaskInstructionArgs {
...
/// `set_task` CPI accounts.
pub struct SetTaskCpiAccounts<'a, 'b> {
    /// Payer account
...
/// `set_task` CPI instruction.
pub struct SetTaskCpi<'a, 'b> {
    ...
    pub __args: SetTaskInstructionArgs,
}

impl<'a, 'b> SetTaskCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SetTaskCpiAccounts<'a, 'b>,
        args: SetTaskInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetTask` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   2. `[]` system_program
#[derive(Clone, Debug)]
pub struct SetTaskCpiBuilder<'a, 'b> {
    instruction: Box<SetTaskCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetTaskCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetTaskCpiBuilderInstruction {
            __program: program,
            payer: None,
            schema: None,
            system_program: None,
...
#[derive(Clone, Debug)]
struct SetTaskCpiBuilderInstruction<'a, 'b> {
