      ...
      '/examples/': [
        {
          ...
          items: [
            ...
            { text: 'Amounts nobody knows at signing', link: '/examples/runtime-values' },
            { text: 'Work that should not always happen', link: '/examples/conditional' },
            { text: 'Loops that read as they go', link: '/examples/loops' },
            {
              text: 'Live protocols',
              link: '/examples/protocols/',
              collapsed: true,
              items: [
                { text: 'Deposit a swap\u2019s output', link: '/examples/protocols/jupiter-deposit' },
                ...
                { text: 'A tip you only pay when you earned it', link: '/examples/protocols/jito-tip' },
                { text: 'Gate on a fresh price', link: '/examples/protocols/pyth-gate' },
                { text: 'Compound the fees you collected', link: '/examples/protocols/orca-compound' },
                { text: 'Harvest only what earned', link: '/examples/protocols/orca-harvest' },
                { text: 'Repay what the swap produced', link: '/examples/protocols/kamino-repay' },
                { text: 'Liquidate and prove it paid', link: '/examples/protocols/kamino-liquidate' },
                { text: 'Empty a position, insist it was worth it', link: '/examples/protocols/marginfi-withdraw' },
                { text: 'Rebalance between venues', link: '/examples/protocols/drift-rebalance' },
                { text: 'Settle, then withdraw what settled', link: '/examples/protocols/drift-settle' },
              ],
            },
