...
impl AddTask {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddTaskInstructionData::new().try_to_vec().unwrap();
...
pub struct AddTaskInstructionData {
    discriminator: u8,
}

impl AddTaskInstructionData {
    pub fn new() -> Self {
...
pub struct AddTaskInstructionArgs {
    pub task: TaskDefinition,
}

/// Instruction builder for `AddTask`.
///
/// ### Accounts:
///
...
impl AddTaskBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = AddTaskInstructionArgs {
...
/// `add_task` CPI accounts.
pub struct AddTaskCpiAccounts<'a, 'b> {
    /// Payer account
...
/// `add_task` CPI instruction.
pub struct AddTaskCpi<'a, 'b> {
    ...
    pub __args: AddTaskInstructionArgs,
}

impl<'a, 'b> AddTaskCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddTaskCpiAccounts<'a, 'b>,
        args: AddTaskInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddTask` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   2. `[]` system_program
#[derive(Clone, Debug)]
pub struct AddTaskCpiBuilder<'a, 'b> {
    instruction: Box<AddTaskCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddTaskCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddTaskCpiBuilderInstruction {
            __program: program,
            payer: None,
            schema: None,
            system_program: None,
...
#[derive(Clone, Debug)]
struct AddTaskCpiBuilderInstruction<'a, 'b> {
